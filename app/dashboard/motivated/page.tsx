                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="dashboard-grid">
                        ...
                        <Link href="/ideavalidator">
                            ...
                            <div id="idea-validator" className="dashboard-card cursor-pointer"> {/* Added ID for tour */}
                    ...
                    <div id="roadmap-section" className="dashboard-card cursor-pointer"> {/* Added ID for tour */}
