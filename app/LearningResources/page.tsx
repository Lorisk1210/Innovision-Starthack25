        ...
        <div className="min-h-screen bg-gradient-to-br from-white to-gray-50">
            ...
            <main className="container mx-auto px-4 py-12">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl shadow-sm p-6 text-center">
                        <div className="text-4xl font-bold text-blue-600 mx-auto h-12 w-12 flex items-center justify-center mb-4">3</div>
                        <div className="text-4xl font-bold text-gray-900 mb-2">All</div>
